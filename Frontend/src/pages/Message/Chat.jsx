...
const Chat = () => {
  ...
  return (
    ...
    >
      ...
      >
        {messages.length === 0 ? (
          <div className="text-center mt-5 text-muted small fw-bold text-uppercase">
                ...
                <div
                  ...
                  style={{
                    ...
                    borderRadius: isMe
                      ? "20px 20px 4px 20px"
                      : "20px 20px 20px 4px",
                    backgroundColor: isMe ? brandColor : "#ffffff",
      ...
      <div className="p-3 bg-white border-top">
        <div className="d-flex align-items-center gap-2">
          <div className="flex-grow-1 bg-light rounded-pill px-3 py-1 border d-flex align-items-center">
            <input
              type="text"
